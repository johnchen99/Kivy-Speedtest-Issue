...
import math
import errno
# import signal (Note: Deploy Problem)
import socket
import timeit
import datetime
import platform
...
def shell():
    ...
    try:
        ...
        printer('Cannot retrieve speedtest configuration1', error=True)
    ...
    up = str(round(results.upload/ 1000.0 / 1000.0, 2))+" Mbps"
